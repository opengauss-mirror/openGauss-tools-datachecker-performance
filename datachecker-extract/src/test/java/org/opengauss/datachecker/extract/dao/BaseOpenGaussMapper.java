 ...
 */
@Slf4j
public class BaseOpenGaussMapper extends BaseMapperTest<OpgsMetaDataMapper> {
    /**
     * 执行
     */
    ...
    public BaseOpenGaussMapper(String mapperName) {
        super(mapperName, configuration, executor, testDataDir);
    }

    @Override
    public OpgsMetaDataMapper getMapper() {
